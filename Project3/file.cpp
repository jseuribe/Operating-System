...
file::file(string &name, char &new_file_op, int &size, string &loc)
{
    this->name = name;
    file_op = new_file_op;
    this->size = size;
...
void file::change_parameters(string &new_name, char &new_file_op, int &new_size, string &new_loc)
{
    name = new_name;
    file_op = new_file_op;
    size = new_size;
